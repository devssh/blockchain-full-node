    ...
    renderHeader(props) {
        return (<div>
            <div className="header">
                <img className="blockchain-image" src={blockchain_image}></img>
                <center><p className="blockchain-full-node">Blockchain Full Node </p></center>
                <div className="divider"><p className='divider-line'></p></div>
                {
                    this.state.shouldShowRedeem ?
                        <div className="redeem-button"><img className="redeem-icon" src={redeem_btn_selected}></img></div>
                        :
                        <div className="redeem-button" onClick={this.showRedeemTab}><img className="redeem-icon" src={redeem_btn_icon}></img></div>
                }
            </div>
            <div className={`navigation-bar ${this.state.isNavInPosition ? 'fixed-nav' : ''}`}>
                ...
                <a className={`nav-item ${this.state.shouldShowRedeem? 'is-current' : ''}`} onClick={this.showRedeemTab}>Redeem</a>
                {
                ...
                <div className="grid-cont">
                    {props.state.sessionToken && props.state.sessionToken !== "undefined" ? (
                        props.state.role === "redeem" ?
                            <div>{this.renderHeader(props)}<RedeemFlow {...props} /><div className="footer"/> </div>:
                            props.state.role === "full" ?
                                ...
                                : <div> {this.renderHeader(props)} <CreateFlow {...props} /> <div className="footer"/> </div>
